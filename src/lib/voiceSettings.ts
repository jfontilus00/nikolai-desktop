...
export type VoiceSettings = {
  ...
  // NEW: bilingual accuracy boost
  // If true AND sttLanguage is blank => call /detect-language first, then /asr with language=<detected>
